...
// Publication counts DERIVED from the synced ORCID record — never hand-typed,
// so the headline can never drift from the record. Generated by
// scripts/cv/check.mjs, which also gates that no recorded paper is missing here.
#let cv-counts = json("generated/counts.json")
...
#grid(
  ...
  block(width: 100%, inset: (x: 14pt, y: 10pt), {
    ...
    stat-block(str(cv-counts.refereed), "Publications")
